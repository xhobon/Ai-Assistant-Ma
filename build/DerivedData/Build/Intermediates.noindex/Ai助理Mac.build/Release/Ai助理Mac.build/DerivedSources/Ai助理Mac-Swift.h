...
#ifndef AI助理MAC_SWIFT_H
#define AI助理MAC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Ai助理Mac",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC11Ai助理Mac15CustomTextField")
...
@class NSString;
SWIFT_CLASS("_TtC11Ai助理Mac13SpeechService")
...
@interface SpeechService (SWIFT_EXTENSION(Ai助理Mac)) <AVSpeechSynthesizerDelegate>
...
SWIFT_CLASS("_TtC11Ai助理Mac17SpeechTranscriber")
...
SWIFT_CLASS("_TtC11Ai助理Mac25TranslationPageNSTextView")
@interface TranslationPageNSTextView : NSTextView
...
SWIFT_CLASS("_TtC11Ai助理Mac34WebAuthPresentationContextProvider")
@interface WebAuthPresentationContextProvider : NSObject <ASWebAuthenticationPresentationContextProviding>
