...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Ai助理",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8Ai助理15CustomTextField")
...
@class NSString;
SWIFT_CLASS("_TtC8Ai助理13SpeechService")
...
@interface SpeechService (SWIFT_EXTENSION(Ai助理)) <AVSpeechSynthesizerDelegate>
...
SWIFT_CLASS("_TtC8Ai助理17SpeechTranscriber")
...
SWIFT_CLASS("_TtC8Ai助理25TranslationPageNSTextView")
...
SWIFT_CLASS("_TtC8Ai助理34WebAuthPresentationContextProvider")
